...
export default function FullscreenRouteDrawPage() {
  ...
  async function handleNativeGeometrySegmentEdit(segmentEdit) {
    ...
    const controls = compactControlPoints(nextGeometry);
    const payload = routePayloadFromGeometry(nextGeometry, controls, "native-gpx-direct-geometry-edit");

    suppressNextSegmentSyncRef.current = true;
    setPointsPayload(makeRoutePointPayload(controls, "native-gpx-edit-control-points"));
    setRoutedPayload({
  ...
  function handleNativeGeometryChange(nextGeometry, meta = {}) {
    ...
    const controls = compactControlPoints(geometry);
    const payload = routePayloadFromGeometry(
      geometry,
      controls,
      meta?.source || "native-gpx-geometry-edit"
    );
