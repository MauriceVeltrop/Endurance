    ...
    <main className="route-draw-fullscreen route-draw-polished route-draw-immersive">
      ...
      <section className="route-editor-control-layer" aria-label="Route editor controls">
        <div className="route-editor-left-rail" aria-label="Route tools">
          <button type="button" onClick={useCurrentLocation} aria-label="Center map on my location">
            <b>⌖</b>
          </button>
          ...
          <button type="button" onClick={clearRoute} disabled={!points.length} aria-label="Clear full route">
            <b>⌫</b>
          </button>
        </div>
</section>
