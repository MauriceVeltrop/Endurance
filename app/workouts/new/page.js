...
export default function NewWorkoutPage() {
  ...
  const stepLabels = ["Sport", "Method", sport?.step3 || "Structure", isHyrox ? "Build" : "Exercises", "Finish"];
    ...
    try {
      ...
      const { data: workout, error: workoutError } = await supabase.from("workouts").insert({
        ...
        structure: {
          ...
          format: selectedStructureCode, format_name: selectedStructure?.name,
