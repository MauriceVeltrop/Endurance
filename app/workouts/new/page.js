...
const STARTER_EXERCISES = [
  ...
  ["Pull Up", "Back", "Bodyweight"], ["Chin Up", "Back", "Bodyweight"], ["Lat Pulldown (Cable)", "Back", "Cable"], ["Neutral Grip Lat Pulldown", "Back", "Cable"], ["Straight Arm Pulldown", "Back", "Cable"], ["Seated Row (Cable)", "Back", "Cable"], ["Bent Over Row (Barbell)", "Back", "Barbell"], ["Bent Over Row (Dumbbell)", "Back", "Dumbbell"], ["Chest Supported Row (Dumbbell)", "Back", "Dumbbell"], ["Chest Supported Row (Machine)", "Back", "Machine"], ["Rack Pull (Barbell)", "Back", "Barbell"], ["T Bar Row", "Back", "Machine"],
...
function buildExerciseCatalog(globalExercises = [], customExercises = []) {
  ...
  if (!dbExercises.length) return STARTER_EXERCISES;
...
export default function NewWorkoutPage() {
  ...
  async function load() {
    ...
    try {
      ...
      if (globalResult.error) console.warn("Could not load global strength exercises", globalResult.error);
      if (customResult.error) console.warn("Could not load custom strength exercises", customResult.error);

      setExerciseCatalog(buildExerciseCatalog(globalResult.data || [], customResult.data || []));
