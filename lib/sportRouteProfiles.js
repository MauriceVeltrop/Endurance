...
export const SPORT_ROUTE_PROFILES = {
  running: {
    ...
    preferences: ["shortest", "recommended"],
    maxDetourFactor: 1.8,

    // Running baseline after reset:
    // Track is neutral and judged by surface. Path is mildly unfavorable.
    // Dirt, mud, sand and grass are strongly penalized. Detour may go up to 1.8x.
    ...
    suitableWaytypes: ["street", "residential", "footway", "pedestrian", "living_street", "cycleway"],
