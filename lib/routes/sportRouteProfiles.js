...
export const SPORT_ROUTE_PROFILES = {
  running: {
    ...
    // Hard rule in candidate sorting: within 1.6x detour, asphalt/paved/footway
    // infrastructure beats dirt/track/path shortcuts. Keep live routing fast:
    // heavy multi-profile exploration is not used while drawing.
