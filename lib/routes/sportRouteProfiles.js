...
export const SPORT_ROUTE_PROFILES = {
  running: {
    ...
    // Running Road baseline for ORS.
    // Keep unknown surface neutral because OSM/ORS often lacks surface tags.
    // Build route intelligence gradually from these simple, explainable rules.
    suitableSurfaces: ["asphalt", "concrete", "paved", "paving_stones", "sett"],
    unsuitableSurfaces: ["mud", "sand", "ground", "earth", "grass"],
    suitableWaytypes: ["street", "residential", "footway", "cycleway", "pedestrian", "living_street"],
    acceptableWaytypes: ["road", "state_road"],
    unsuitableWaytypes: ["track", "path"],
  },
