...
export const SPORT_ROUTE_PROFILES = {
  running: {
    ...
    // Running GraphHopper baseline:
    // - try GraphHopper foot first when GRAPHHOPPER_API_KEY is available;
    // - keep ORS foot-walking as fallback;
    // - score only waytype for now, not surface yet.
    ...
    acceptableSurfaces: [],
    unsuitableSurfaces: [],
    suitableWaytypes: ["footway", "street", "road", "cycleway"],
