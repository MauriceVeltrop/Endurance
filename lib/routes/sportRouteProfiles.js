...
export const SPORT_ROUTE_PROFILES = {
  running: {
    ...
    // Diagnostic test: all Running preferences are disabled.
    // The only active rule lives in app/api/routes/reroute/route.js:
    // ORS candidates containing highway=path are rejected.
