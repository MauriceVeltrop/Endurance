...
export const SPORT_ROUTE_PROFILES = {
  running: {
    ...
    // Fresh ORS baseline for Running. Keep conditions intentionally minimal.
    // In ORS, "paved" is a separate surface class; asphalt/concrete/paving_stones
    // are also hardened surfaces, so they must be counted as paved/suitable too.
    suitableSurfaces: ["paved", "asphalt", "concrete", "paving_stones"],
    unsuitableSurfaces: ["mud"],
    suitableWaytypes: [],
    unsuitableWaytypes: [],
  },
