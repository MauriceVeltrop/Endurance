...
export const SPORT_ROUTE_PROFILES = {
  running: {
    ...
    // Running surface-only test:
    // - use ORS foot-walking;
    // - keep the request stable and simple;
    // - score only surface first, not waytype/path/track yet.
    ...
    unsuitableSurfaces: ["ground", "mud", "sand", "gravel", "grass", "unpaved", "dirt", "earth", "fine_gravel"],
    suitableWaytypes: [],
    acceptableWaytypes: [],
    unsuitableWaytypes: [],
  },
