...
export const SPORT_ROUTE_PROFILES = {
  running: {
    ...
    // Diagnostic baseline:
    // Running has no Endurance-specific surface, waytype, detour, corridor,
    // candidate-rejection or quality preferences. ORS decides the shortest
    // legal foot-walking route between A and B.
    suitableSurfaces: [],
    acceptableSurfaces: [],
    unsuitableSurfaces: [],
    suitableWaytypes: [],
