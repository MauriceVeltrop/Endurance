...
export const SPORT_SURFACE_RULES = {
  ...
  mountain_biking: {
    offRoadFirst: true,
    minOffRoadRatio: 0.45,
    maxPavedConnectorRatio: 0.50,
    ideal: ["ground", "dirt", "unpaved", "gravel", "compacted_gravel", "fine_gravel", "likely_unpaved", "likely_gravel", "estimated_trail_surface", "estimated_gravel_surface"],
    acceptable: ["likely_compacted", "asphalt", "paved", "concrete", "likely_paved", "estimated_paved_surface"],
    avoid: ["ice"],
  },
  mtb: {
