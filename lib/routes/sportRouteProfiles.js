...
export const SPORT_ROUTE_PROFILES = {
  running: {
    label: "Running",
    routingProvider: "ors",
    providerProfiles: ["foot-walking", "cycling-regular"],
    ...
    // cycling-regular is included as a paved-infrastructure fallback candidate;
    // scoring still rejects unsafe road-heavy or trail-heavy alternatives.
