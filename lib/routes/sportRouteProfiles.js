...
export const SPORT_ROUTE_PROFILES = {
  running: {
    ...
    // Running v1 simple profile:
    // prefer hard/compact surfaces, keep track neutral, penalize path lightly,
    // and heavily avoid mud/dirt/sand/grass. Surface is more important than
    // waytype: a good compact/asphalt track is acceptable; a muddy path is not.
    suitableSurfaces: ["asphalt", "concrete", "paved", "paving_stones", "sett"],
    acceptableSurfaces: ["compacted", "fine_gravel", "gravel"],
    unsuitableSurfaces: ["mud", "dirt", "sand", "grass", "ground", "earth"],
    suitableWaytypes: ["street", "residential", "footway", "cycleway", "pedestrian", "living_street", "service"],
    acceptableWaytypes: ["track", "road"],
    unsuitableWaytypes: ["path", "state_road", "steps"],
  },
