...
export const SPORT_ROUTE_PROFILES = {
  running: {
    ...
    fallbackProviderProfiles: ["foot-walking"],
    preferences: ["recommended"],
    maxDetourFactor: 1.6,
    graphhopperCustomModel: {
      distance_influence: 90,
      priority: [
        { if: "surface == ASPHALT", multiply_by: "1.4" },
        { if: "surface == CONCRETE", multiply_by: "1.35" },
        { if: "surface == PAVED", multiply_by: "1.3" },
        { if: "surface == PAVING_STONES", multiply_by: "1.15" },
        { if: "surface == GRAVEL", multiply_by: "0.05" },
        { if: "surface == FINE_GRAVEL", multiply_by: "0.05" },
    ...
    suitableSurfaces: ["asphalt", "concrete", "paved", "paving_stones"],
    acceptableSurfaces: ["compacted", "fine_gravel"],
    unsuitableSurfaces: ["mud", "sand", "grass", "dirt", "ground", "gravel", "unpaved"],
    suitableWaytypes: ["footway", "cycleway", "street", "pedestrian"],
    unsuitableWaytypes: ["track", "steps"],
  },
