...
export const SPORT_ROUTE_PROFILES = {
  running: {
    ...
    // Diagnostic baseline: all Running-specific route logic is disabled.
    // No path filter, no surface rules, no scoring preferences.
    // ORS foot-walking/shortest decides the route.
